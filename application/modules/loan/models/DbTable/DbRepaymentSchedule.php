...
//     		$this->update($arr_update, $where);
    		...
    		$where = " status=1 AND is_completed=0 AND member_id =".$data['group_id'];
    		$this->delete($where);
    		$member_id = $data['group_id'];
    		
    		$sql="  SELECT COUNT(id) FROM ln_loanmember_funddetail WHERE member_id= ".$data['group_id'];
