...
// 		$id->setAttrib('dojoType', 'dijit.form.TextBox');
		...
		$release_date->setAttribs(array('dojoType'=>'dijit.form.TextBox',
				'constraints'=>"{datePattern:'dd/MM/yyyy'}",'class'=>'fullside','readOnly'=>'readOnly'));
		
		$old_release_date = new Zend_Form_Element_Hidden("old_release_date");
		$old_release_date->setAttribs(array('dojoType'=>'dijit.form.TextBox','constraints'=>"{datePattern:'dd/MM/yyyy'}",'class'=>'fullside','readOnly'=>'readOnly'));
