...
class Pawnshop_PaymentController extends Zend_Controller_Action {
	...
	public function indexAction(){
		...
		if($this->getRequest()->isPost()){
			...
			$collumns = array("BRANCH_NAME","PAWN_NO","CUSTOMER_NAME","RECIEPT_NO","TOTAL_PRINCEPLE","TOTAL_INTEREST","PENALIZE AMOUNT","TOTAL_PAYMENT","RECEIVE_AMOUNT","PAY_DATE","DATE"
				);
			$link=array(
...
// 		}
// 	}
	function getsavingpaymentAction(){
		if($this->getRequest()->isPost()){
			$data = $this->getRequest()->getPost();
			$db = new Pawnshop_Model_DbTable_DbPayment();
